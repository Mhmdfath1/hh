...
/*$(document).ready(function() {
  ...
  $(".btn-sa").mouseover(function() {

    $(this).css({ "background-color": "#198bd7", "transition": ".Ss" }).siblings().css("background-color", "transparent");
  });

  $(".btn-sa").mouseout(function() {
    $(this).css("background-color", "transparent");

    $(".active").css("background-color", "#198bd7");
